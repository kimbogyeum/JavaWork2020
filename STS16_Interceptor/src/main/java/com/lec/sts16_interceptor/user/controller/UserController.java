...
public class UserController {
	...
	public String loginOk(String id, String pw, HttpSession session) {//파라미터값 2개랑 session.
		String returnURL="";
		...
		if(ADMIN_ID.equals(id) && ADMIN_PW.equals(pw)) {
			...
			if(priorUrl!=null) {
				returnURL="redirect:"+priorUrl;//원래 가고자 했던곳으로 redirect 시켜주기
				session.removeAttribute("url_prior_login");//원래 세션은 지워주기
			}else {
