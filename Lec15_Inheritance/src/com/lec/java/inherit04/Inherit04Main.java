...
public class Inherit04Main {
	...
	public static void main(String[] args) {
		...
		HybridCar h1= new HybridCar();//반드시 부모부터 생성 vehicle->car->hybrid
		System.out.println(h1.electricity);
		System.out.println(h1.oil);
		System.out.println(h1.speed);//지정을 안했으니 0이 나오겠지 
		
		
		Car car4=new Car(3.14);
		/*
		 *  Vehicle(int)생성: speed=555
			Car(int,int) 생성: speed=555 oil=3
			Car(double)생성: value=3.14
		 */
