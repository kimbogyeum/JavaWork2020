...
public class DateTime01Main {
	...
	public static void main(String[] args) throws Exception{
		...
		String strNow2=fmt.format(now);//SimpleDateFormat 에 format이라는 메소드?
		...
		long baseTime=System.currentTimeMillis();//현재시각 ms로 리턴 1/1000로리턴
		//1970-01-01 00:00:00 UTC 기준으로 경과된 ms
//		System.out.println(baseTime);
		long curTime=baseTime+2000; //2초 뒤의 시간값 ms
		SimpleDateFormat mSimpleDateFormat= new SimpleDateFormat("YYYY:MM:dd-HH:mm:ss",Locale.KOREA);
		mSimpleDateFormat.format(new Date(baseTime));
		...
		long durationInMillis=1000003;//100만초는 몇시몇분몇초일까 2300->2.3초
