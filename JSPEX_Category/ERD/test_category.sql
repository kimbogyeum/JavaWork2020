...
INSERT INTO test_category VALUES(test_category_seq.nextval, '의류', 1, 0, 1);
INSERT INTO test_category VALUES(test_category_seq.nextval, '식품', 1, 0, 3);
INSERT INTO test_category VALUES(test_category_seq.nextval, '스포츠', 1, 0, 2);
...
--depth 2이면서 부모 uid 가 1인 카테고리 읽기 order 오름차순 순서로 
SELECT ca_uid "uid", ca_name name, ca_depth DEPTH, ca_parent parent, ca_order "order" FROM  TEST_CATEGORY 
