...
public class Wrapper02Main {
	...
	public static void main(String[] args) {
		...
		//auto-boxing: Integer.valueOf(10);
		//auto-unboxing:num2.intValue()
		Integer num1=10;//Integer.valueOf(10);<--auto-boxing
		Integer num2=20;
		System.out.println(num1+num2);//각각의 wrapper에서 10,20을 꺼내서 더하는것. auto-unboxing
		System.out.println(num1.intValue()+num2.intValue());//<--굳이 명시하자면 이와같이 동작
		
		Integer num3=num1+num2;
		Integer num30=Integer.valueOf(num1.intValue()+num2.intValue());//위에꺼 실행순서대로 fullname적어보면
