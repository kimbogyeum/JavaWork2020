...
public class PrintFormatMain {
	public static void main(String[] args) {
		...
		System.out.printf("제이름은 [%10s]입니다. 혈액형은 %c형 입니다.\n","봉준호",'B'); //'B'는 character이니까 ''로 막아주기. 
		
		//%출력
		double rate=134423.0/345678.0;
		System.out.printf("합격률은 %.1f%%입니다.\n",rate); //%을 서식지정자라고 착각하기때문에 %쓰고싶으면 %%로 쓰기
		
		//숫자에 패딩
		System.out.printf("|%05d|%05d|%05d|\n",100,200,300); //5칸중에 빈칸을 0으로 채워주세요
		...
		String result=String.format("합격률은 %.1f%% 입니다",rate);//화면 출력용이 아님.
