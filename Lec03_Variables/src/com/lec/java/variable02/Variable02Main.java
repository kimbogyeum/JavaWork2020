...
public class Variable02Main {
	...
	public static void main(String[] args) {
		...
		byte num2=0;
		byte num3=123;
//		byte num4=1234; //에러: byte에 저장할 수 있는 크기를 넘어섬 -128~127
		
		System.out.println("short: "+Short.MIN_VALUE+"~"+Short.MAX_VALUE);
		short num5=-12345;
		short num6=12345;
//		short num7=32768; //에러: byte에 저장할 수 있는 크기를 넘어섬 -32768~32767
...
//		long num10=9876543210; //The literal 9876543210 of type int is out of range
		//literal: 코드상에 직접 입력한 값들
			//정수 리터럴--> int로 형변환 하려 한다. 정수타입중에 int가 대표적
			//실수 리터럴--> double로 형변환 하려 한다. 실수타입중에 double이 대표적
			// "~"리터럴--> 문자열(string)로 형변환
		long num11=9876543210L; // long형 리터럴로 인식-> 8byte를 8byte로 대입
		long num12=12;
		long num13=12L;
		int num14=12;
//		int num15=12L; //long 타입을  int 에 대입불가 -> 큰타입을 작은타입에 대입불가
		...
		System.out.println("number1= "+String.format("%x", number1));//%x는 16진법
		System.out.println("number1= "+String.format("%o", number1));//%o는 8진법
