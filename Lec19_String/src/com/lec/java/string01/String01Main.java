...
//		System.out.println("str1의 길이: "+str1.length());
		...
		System.out.println(str1);//바뀐걸 확인할 수 있음. 
		...
		System.out.println(str3.length());
		str3=null;// String객체가 존재하지 않음.
		//System.out.println(str3.length());//NullPointerException, null에는 점을 붙일 수 없다..?
		...
		System.out.println(str10.replace("Language", "Java"));//매칭되는 모든걸 치환함
