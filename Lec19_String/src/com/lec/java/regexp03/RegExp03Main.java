...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		arrInput = new String[] {
				"The Things",
				"On The Things",//이건 매칭 안됨. The로 시작하지 않으니까
				" The The The",//앞에 공백도 매칭안됨.
				"The The the The"//1개 매칭됨 The{0~3}
		};
		//─────────────────────────────────────────
		title = "$ : 문자열의 마지막이 이 문자열로 마무리 됨";
		regex = "Man$"; // Man으로 끝나느 문자열 패턴
		arrInput = new String[] {
				"SuperMan",
				"AquaMan",
				"WonderWoman",//X
		...
		arrInput = new String[] {
				...
				"xbz",				
				"xyyz x1y xyyy xxxyyyxxyyxyxyxyyyxyxyxyxyxy"
		};
		...
		regex="[a-zA-Z]+";
		regex="[a-zA-Z0-9]+";//두덩어리
		regex="[a-zA-Z0-9-]+";//한덩어리
		...
		regex="^[1-9][0-9]*";//자연수이려면 첫글자는 1~9, 마지막글자는 0~9
		...
		regex = "a(bc)*"; //*은 없거나 하나이상-> bc가 없거나 하나이상
		arrInput = new String[] {
				"abc",
				"abcbcbbc",
				"abcabcabc",
