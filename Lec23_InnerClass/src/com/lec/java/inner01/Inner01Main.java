...
public class Inner01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		//하나의 외부 클래스 인스턴스를 이용해서 멤버 내부 클래스의 인스턴스는 여러개 생성가능.
		...
		//새로운 외부클래스 인스턴스 생성
		//out2 외부클래스 인스턴스 생성
		//out2로부터 in4,in5라는 이름으로 내부 클래스 객체 만드세요.
		TestOuter out2=new TestOuter();
		TestOuter.TestInner in4=out2.new TestInner(1);
		in4.printOuterValue();
		in4.printInnerValue();
		System.out.println();
		TestOuter.TestInner in5=out2.new TestInner(2);
		in5.printOuterValue();
		in5.printInnerValue();
