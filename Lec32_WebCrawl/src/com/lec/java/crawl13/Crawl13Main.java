...
public class Crawl13Main {
	...
	public static void main(String[] args) {
		System.out.println("jackson-databind 사용 / JSON으로 타입 바꿔주기");
		
		User user=new User();
		user.setName("제이슨");
		user.setAge(10);
		user.setScore1(new Score(100,50,60));
		List<String> list=new ArrayList<String>();
		list.add("JSON은 Javascript Object Notation의 약자입니다.");
		list.add("JSON은 데이터 교환 포맷으로 인기짱입니다.");
		list.add("JSON은 배열이 있습니다.(XML보다 장점!)");
		list.add("JSON은 타입검증에 대해선 XML보다 약합니다.");
