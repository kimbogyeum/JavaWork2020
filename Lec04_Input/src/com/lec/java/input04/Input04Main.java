...
public class Input04Main {
	...
	public static void main(String[] args) {
		...
		String in1=sc.next();
		int i1=Integer.parseInt(in1);//만약 숫자 3개가 아닌 aaa bbb ccc쓰면 int로 못바꿔서 에러남
		...
		//TODO
		//실수 3개를 문자열로 입력받아서 (next())곱을 구하시오 
		
		System.out.println("실수 3개(double, double, double)를 입력받으시오: ");
