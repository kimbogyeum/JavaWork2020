...
let dog=new Animal('개','멍멍','왈왈');
let cat=new Animal('고양이','얗옹','하악');
...
bird=new Animal2('새','짹짹',"짹짹이");
tiger=new Animal2('호라이','큰냥이',"어흥");
bird.say();
tiger.say();


//prototype 에 정의해 놓으면 모든 객체가 공통으로 사용가능하다. 
//bird,tiger에도 sharedValue 없으니까 Animal2.prototype.sharedValue=1;으로 간다. 
Animal2.prototype.sharedValue=1;
console.log(bird.sharedValue);
console.log(tiger.sharedValue);

//bird는 sharedValue를 만들어주었지만 tiger은 안만들어줘서 타고타고 올라간다. 
bird.sharedValue=10;
console.log(bird.sharedValue);
console.log(tiger.sharedValue);