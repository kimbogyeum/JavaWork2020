...
const numbers={
    ...
    //getter 함수
     get sum(){
         ...
         //return 이 빠지면 undefined
     }
}

//getter 함수는 아래와 같이 '조회'하려할때 함수가 호출, 실행됩니다.
//console.log(numbers.sum()); 는 에러가 난다. 
...
const dog={
    ...
    //setter 반드시 set 키워드로 시작해야한다. 
    set name(value){
        //반드시 parametmer 설정되어야 한다. 
