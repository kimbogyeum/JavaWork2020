...
public class Operator04Main {
	...
	public static void main(String[] args) {
		...
		//++: 변수값 1 증가 // num1=num1+1, num1+=1과 동일한 결과
		++num1;
		System.out.println("num1= "+num1);
		...
		int num6=100;
		int num7=num6++;//postfix:++보다 대입연산자=가 먼저 수행된다.
		...
		int num10=10;
		int num11=num10-- +5;//--보다 +가 먼저 실행된다. 
		...
		//답이 24가 아니라 23인 이유: +5까지는 number1이 +5수행 후 15가 되고 number1은 9로 바뀜. 이후에 prefix이므로 8로 바뀐채로 15에 더해짐.
