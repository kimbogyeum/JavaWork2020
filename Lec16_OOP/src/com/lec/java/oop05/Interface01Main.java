...
public class Interface01Main {
	...
	public static void main(String[] args) {
		...
		//모호성 에러 TestImpl2가 interface1,2를 다 상속받고있으니까 MIN이 1인지 0인지 모르겠지?
		//그래서 static 은 static으로 쓰자. 
